...
Employ two rounds of template resolution: the first for localization and the second for personalization. Find the source code on [GitHub](https://github.com/acomathes/mail-microservice).
...
If you feel like you can improve [this microservice](https://github.com/acomathes/mail-microservice), feel free to fork it and send a pull request.
